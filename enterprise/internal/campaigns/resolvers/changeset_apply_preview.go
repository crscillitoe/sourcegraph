...
func (r *changesetApplyPreviewResolver) computePlan(ctx context.Context) (*ee.ReconcilerPlan, error) {
	r.planOnce.Do(func() {
		...
		rewirer := ee.NewChangesetRewirer(ee.RewirerMappings{r.mapping}, campaign.ID)
...
func (r *changesetApplyPreviewResolver) ChangesetSpec(ctx context.Context) (graphqlbackend.ChangesetSpecResolver, error) {
	...
	return NewChangesetSpecResolverWithRepo(r.store, r.httpFactory, r.mapping.Repo, r.mapping.ChangesetSpec), nil
}
...
func (r *changesetApplyPreviewResolver) Changeset(ctx context.Context) (graphqlbackend.ChangesetResolver, error) {
	...
	return NewChangesetResolverWithNextSync(r.store, r.httpFactory, r.mapping.Changeset, r.mapping.Repo, r.preloadedNextSync), nil
}
